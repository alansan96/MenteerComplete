...
class MenteeChatController: UIViewController {

    @IBOutlet weak var tableView: UITableView!
    var uss = [LoginUser]()
    var imageUser = ["Castro", "Ayu", "Bagus", "Amy","Robin Shue Mentor", "Tim Berkeley Mentor", "Amy", "Ayu", "Bagus", "Castro","Robin Shue Mentor", "Tim Berkeley Mentor"]
...
extension MenteeChatController: UITableViewDataSource, UITableViewDelegate{
