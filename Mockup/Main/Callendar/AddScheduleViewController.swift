...
//  Mockup
//
//  Created by Jesse Joseph on 29/04/19.
...
class AddScheduleViewController: UIViewController {
    ...
    @IBAction func addTaskTapped(_ sender: Any) {
        ...
        let angka : ScheduleNewViewController = ScheduleNewViewController(nibName: nil, bundle: nil)
        var getThatValue = angka.schedule
        
        var schedule1 = Schedule(title: taskTF.text!, date: "2019/04/30")
        getThatValue.append(schedule1)

        skedul2 = getThatValue
